...
export function ArrangementTimeline({
  ...
  const sectionOverrideCount = arrangement.sections.filter((_, index) =>
    effectiveSectionProductionAt(arrangement, index).locked
  ).length;
              ...
              <article
                className={
                  ...
                  (arrangement.lockedSymbols.includes(section.symbol)
                    ? "locked"
                    : "") +
                  (sectionProduction.locked ? " production-locked" : "")
                }
                key={section.id}
                style={{
                  "--section-energy": sectionProduction.energy + "%"
                ...
                <div className="timeline-section-head">
                  ...
                  <div className="timeline-section-copy">
                    ...
                    <small>
                      ...
                      · 能量 {sectionProduction.energy} · {getVoicingProfile(
                        sectionProduction.voicingMode
                      ).label}
                      {sectionProduction.locked ? " · 已锁定" : "声部"}
                    </small>
                  </div>
